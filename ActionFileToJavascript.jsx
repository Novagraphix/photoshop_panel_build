...
//
// $Id: ActionFileToJavascript.jsx,v 1.55 2014/05/01 18:33:49 anonymous Exp $
...
Stdlib.RcsId = "$Id: ActionFileToJavascript.jsx,v 1.55 2014/05/01 18:33:49 anonymous Exp $";
...
Action.prototype.readDroplet = function(str) {
  ...
  if (!m) {
    Error.runtimeError(ATN_ERR, "Bad droplet format. Unable to extract action.");
  }
